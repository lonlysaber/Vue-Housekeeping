    ...
    <div class="container">
      ...
      >
        ...
        >
          ...
          <!-- <el-table-column prop="userAccount" label="登录名">
                    </el-table-column> -->
              ...
              >
                ...
                >
                  <el-form-item label="用户名">
                    <el-input v-model="update_Client.userName"></el-input>
                  </el-form-item>
                  <el-form-item label="手机号">
                    <el-input v-model="update_Client.userPhone"></el-input>
                  </el-form-item>

                  <el-form-item label="用户密码">
                    <el-input
                      v-model="update_Client.userPwd"
                      show-password
                    ></el-input>
...
export default {
  ...
  methods: {
    ...
    queryCondition(params) {
      ...
      this.$store
        .dispatch("user/queryCondition", params)
        .then((response) => {
    ...
    //根据ID搜索客户
    queryClientById() {
      const params = { userId: this.searchID };
    ...
    //根据姓名搜索客户
    queryClientByName() {
      const params = { userName: this.searchName };
      this.queryCondition(params);
      this.searchName = "";
    },
    ...
    //根据手机号搜索客户
    queryClientByPhone() {
      const params = { userPhone: this.searchPhone };
      this.queryCondition(params);
      this.searchPhone = "";
    },
    ...
    queryPurchase(client) {
      this.$store
        .dispatch("user/getOrder", client.userId)
        .then((res) => {
    ...
    delClient(client) {
      ...
      this.$confirm("此操作将永久删除该用户, 是否继续?", "提示", {
        ...
        .then(() => {
          this.$store
            .dispatch("user/deleteUser", this.clientId)
            .then((request) => {
              this.$message({
                showClose: true,
                type: "success",
