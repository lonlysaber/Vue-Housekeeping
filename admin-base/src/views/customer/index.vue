    ...
    <div class="content-box">
        <div class="container">
                            ...
                            <el-dialog title="修改信息" :visible.sync="dialogVisible" width="30%"
                                ...
                                <el-form ref="updateform" :model="update_Client" label-width="80px">
                                    ...
                                    <el-form-item label="手机号">
                                        <el-input v-model="update_Client.phone"></el-input>
                                    </el-form-item>
                                    <!-- <el-form-item label="登录名">
                                        <el-input v-model="update_Client.clientAccount"></el-input>
                                    </el-form-item> -->
                                    <el-form-item label="用户密码">
                                        <el-input v-model="update_Client.password" show-password></el-input>
                                    </el-form-item>
                                </el-form>
            ...
            <el-table :data="clientData.slice((currentPage - 1) * pagesize, currentPage * pagesize)" border
                ...
                :cell-style="{ 'text-align': 'center' }" style="margin-top: 8px; text-align: center">
                ...
                <el-table-column  label="查询" width="180">
                    <template slot-scope="scope">
                        ...
                        <!-- 查询用户订单 -->
                        <el-button @click="queryPurchase(scope.row)" size="small">订单</el-button>
                        ...
                        <!-- 查询用户房源 -->
                        <el-button @click="queryMyHouse(scope.row)"  size="small">房源</el-button>&nbsp;
